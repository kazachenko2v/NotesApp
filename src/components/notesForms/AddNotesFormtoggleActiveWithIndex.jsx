...
const AddNotesForm = ({ item, toggleActiveWithIndex }) => {
  const { addNoteWithIndex } = useContext(NotesContext);
  ...
  function createNewNote() {
    addNoteWithIndex(
      { ...note, tags: findTags(note.title + " " + note.body) },
      prompt("какрй индекс?")
    );
    toggleActiveWithIndex();
    setNote({ title: "", body: "" });
  }
